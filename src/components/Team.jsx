        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="team">
              ...
              <p style={{ marginTop: '15px', color: '#64748b', fontSize: '22px', lineHeight: 1.6 }}>Developed with clinical psychologists, neuroscientists, and performance coaches who understand the brain.</p>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="team">
              ...
              <p style={{ marginTop: '15px', color: '#64748b', fontSize: '22px', lineHeight: 1.6 }}>Years of analyzing behavioral patterns to create systems that optimize human performance and reduce burnout.</p>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="team mb-0">
              ...
              <h4>Why Trust Us?</h4>
              <p style={{ marginTop: '15px', color: '#64748b', fontSize: '22px', lineHeight: 1.6 }}>Used by 5,000+ individuals across the US. We prioritize data privacy, objective metrics, and actionable protocols.</p>
            </div>
          </div>
        </div>
