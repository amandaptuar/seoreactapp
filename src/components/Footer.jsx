            ...
            <div className="col-lg-4">
              <div className="footer-logo">
                ...
                <div style={{ marginTop: '15px', padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', borderLeft: '3px solid #F59E0B' }}>
                  <p style={{ color: '#94a3b8', fontSize: '18px', margin: 0, lineHeight: 1.5 }}>
      ...
      <div className="bottom-bar" style={{ backgroundColor: '#0d0d0d', padding: '20px 0' }}>
        <div className="container">
          <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <p className="text-white mb-0" style={{ fontSize: '21px' }}>Limitless Holistic Cognition © 2026. All Rights Reserved.</p>
            <div className="d-flex align-items-center gap-3">
              <Link to="/privacy-policy" className="text-white" style={{ fontSize: '21px', textDecoration: 'none' }}>Privacy Policy</Link>
              <span className="text-white" style={{ fontSize: '21px' }}>|</span>
              <Link to="/terms-conditions" className="text-white" style={{ fontSize: '21px', textDecoration: 'none' }}>Terms of Condition</Link>
            </div>
            <ul className="social-media d-flex mb-0" style={{ gap: '15px', listStyle: 'none', padding: 0, margin: 0 }}>
              <li><a href="https://www.facebook.com/limitlessworldnet" target="_blank" rel="noopener noreferrer" className="text-white" style={{ fontSize: '23px' }}><i className="fa-brands fa-facebook-f"></i></a></li>
              <li><a href="https://x.com/limitless1964" target="_blank" rel="noopener noreferrer" className="text-white" style={{ fontSize: '23px' }}><i className="fa-brands fa-twitter"></i></a></li>
              <li><a href="#" className="text-white" style={{ fontSize: '23px' }}><i className="fa-brands fa-instagram"></i></a></li>
              <li><a href="#" className="text-white" style={{ fontSize: '23px' }}><i className="fa-brands fa-linkedin-in"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
