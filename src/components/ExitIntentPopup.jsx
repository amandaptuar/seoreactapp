  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: '62px', marginBottom: '15px' }}>🧠</div>
        <h2 style={{ color: '#0F172A', fontSize: '38px', fontWeight: '800', marginBottom: '15px', lineHeight: 1.2 }}>
          Wait! Get your free cognitive score before leaving.
        </h2>
        <p style={{ color: '#6B7280', fontSize: '23px', marginBottom: '25px' }}>
        ...
        <button
          ...
          style={{
            ...
            color: '#ffffff', border: 'none', borderRadius: '12px', fontWeight: '700', fontSize: '26px',
