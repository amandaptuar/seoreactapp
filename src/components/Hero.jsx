              ...
              <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: '1 1 200px' }}>
                    ...
                    <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="John Doe" style={{ width: '100%', padding: '14px', borderRadius: '12px', border: errors.name ? '2px solid red' : '1px solid #E2E8F0', outline: 'none', fontSize: '18px', background: '#F8FAFC' }} required />
                    {errors.name && <span style={{ color: '#ef4444', fontSize: '13px', fontWeight: '500', marginTop: '-4px' }}>{errors.name}</span>}
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: '1 1 200px' }}>
                    ...
                    {errors.email && <span style={{ color: '#ef4444', fontSize: '13px', fontWeight: '500', marginTop: '2px' }}>{errors.email}</span>}
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: '1 1 100px' }}>
                    ...
                    <input type="text" name="age" value={formData.age} onChange={handleChange} placeholder="22" style={{ width: '100%', padding: '14px', borderRadius: '12px', border: errors.age ? '2px solid red' : '1px solid #E2E8F0', outline: 'none', fontSize: '18px', background: '#F8FAFC' }} required />
                    {errors.age && <span style={{ color: '#ef4444', fontSize: '13px', fontWeight: '500', marginTop: '-4px' }}>{errors.age}</span>}
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: '1 1 100px' }}>
                    <label style={{ fontSize: '15px', fontWeight: '700', color: '#475569', textTransform: 'uppercase', letterSpacing: '1px' }}>Gender</label>
                    <select name="gender" value={formData.gender} onChange={handleChange} style={{ width: '100%', padding: '14px', borderRadius: '12px', border: errors.gender ? '2px solid red' : '1px solid #E2E8F0', outline: 'none', fontSize: '18px', background: '#F8FAFC', color: '#0F172A' }} required>
                      <option value="">Select Gender</option>
                      <option value="female">Female</option>
                      <option value="male">Male</option>
                    </select>
                    {errors.gender && <span style={{ color: '#ef4444', fontSize: '13px', fontWeight: '500', marginTop: '-4px' }}>{errors.gender}</span>}
                  </div>
                </div>
