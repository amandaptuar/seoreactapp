...
export default function Dashboard() {
  ...
  const trialUsers = users.filter((u) => u.payment_status === 'trial' || u.payment_status === 'demo').length
  ...
  const planData = [
    ...
    { name: "Trial/Demo", value: trialUsers, color: "hsl(var(--warning))" },
    { name: "Inactive", value: totalUsers - activeUsers - trialUsers, color: "hsl(var(--muted-foreground))" },
  ].filter(p => p.value > 0)
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KPICard title="Trial Users" value={trialUsers.toLocaleString()} delta="+0%" deltaType="neutral" icon={PlayCircle} />
      </div>
